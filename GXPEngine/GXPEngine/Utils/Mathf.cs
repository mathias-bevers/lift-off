...
namespace GXPEngine
{
    ...
    public static class Mathf
    {
        ...
        public static bool CircleOverlap(Vector2 pos1, float radius1, Vector2 pos2, float radius2)
        {
            return Vector2.Distance(pos1, pos2) <= radius1 + radius2;
        }

        public static bool RectOverlap(Vector2 pos1, Vector2 scale, Vector2 point)
        {
            return (point.x > pos1.x && point.x < pos1.x + scale.x && point.y > pos1.y && point.y < pos1.y + scale.y);
        }

        public static float Dot(Vector2 first, Vector2 other)
        {
        ...
        {
            return Atan2(Sin(angle * PI / 180.0f), Cos(angle * PI / 180.0f)) * 180.0f / PI;
        }
